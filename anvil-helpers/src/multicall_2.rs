...
pub mod multicall_2 {
                            ...
                            inputs: ::std::vec![
                                ::ethers::core::abi::ethabi::Param {
                                    ...
                                    internal_type: ::core::option::Option::Some(
                                        ::std::borrow::ToOwned::to_owned("struct Multicall2.Call[]"),
                                    ),
                                },
                            ],
                            outputs: ::std::vec![
    ...
    pub static MULTICALL2_ABI: ::ethers::contract::Lazy<::ethers::core::abi::Abi> = ::ethers::contract::Lazy::new(
        __abi,
    );
    pub struct Multicall2<M>(::ethers::contract::Contract<M>);
    impl<M> ::core::clone::Clone for Multicall2<M> {
        fn clone(&self) -> Self {
            Self(::core::clone::Clone::clone(&self.0))
        }
    }
    impl<M> ::core::ops::Deref for Multicall2<M> {
        type Target = ::ethers::contract::Contract<M>;
        fn deref(&self) -> &Self::Target {
            &self.0
        }
    }
    impl<M> ::core::ops::DerefMut for Multicall2<M> {
        fn deref_mut(&mut self) -> &mut Self::Target {
            &mut self.0
        }
    }
    impl<M> ::core::fmt::Debug for Multicall2<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(::core::stringify!(Multicall2)).field(&self.address()).finish()
        }
    }
    ...
    impl ::ethers::core::abi::AbiDecode for Multicall2Calls {
        fn decode(
            ...
            if let Ok(decoded)
                = <GetBlockHashCall as ::ethers::core::abi::AbiDecode>::decode(data) {
            ...
            if let Ok(decoded)
                = <TryAggregateCall as ::ethers::core::abi::AbiDecode>::decode(data) {
    ...
    impl ::core::fmt::Display for Multicall2Calls {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
    ...
    impl ::core::convert::From<AggregateCall> for Multicall2Calls {
        fn from(value: AggregateCall) -> Self {
            Self::Aggregate(value)
        }
    }
    impl ::core::convert::From<BlockAndAggregateCall> for Multicall2Calls {
        fn from(value: BlockAndAggregateCall) -> Self {
            Self::BlockAndAggregate(value)
        }
    }
    impl ::core::convert::From<GetBlockHashCall> for Multicall2Calls {
        fn from(value: GetBlockHashCall) -> Self {
            Self::GetBlockHash(value)
        }
    }
    impl ::core::convert::From<GetBlockNumberCall> for Multicall2Calls {
        fn from(value: GetBlockNumberCall) -> Self {
            Self::GetBlockNumber(value)
        }
    }
    impl ::core::convert::From<GetCurrentBlockCoinbaseCall> for Multicall2Calls {
        fn from(value: GetCurrentBlockCoinbaseCall) -> Self {
            Self::GetCurrentBlockCoinbase(value)
        }
    }
    impl ::core::convert::From<GetCurrentBlockDifficultyCall> for Multicall2Calls {
        fn from(value: GetCurrentBlockDifficultyCall) -> Self {
            Self::GetCurrentBlockDifficulty(value)
        }
    }
    impl ::core::convert::From<GetCurrentBlockGasLimitCall> for Multicall2Calls {
        fn from(value: GetCurrentBlockGasLimitCall) -> Self {
            Self::GetCurrentBlockGasLimit(value)
        }
    }
    impl ::core::convert::From<GetCurrentBlockTimestampCall> for Multicall2Calls {
        fn from(value: GetCurrentBlockTimestampCall) -> Self {
            Self::GetCurrentBlockTimestamp(value)
        }
    }
    impl ::core::convert::From<GetEthBalanceCall> for Multicall2Calls {
        fn from(value: GetEthBalanceCall) -> Self {
            Self::GetEthBalance(value)
        }
    }
    impl ::core::convert::From<GetLastBlockHashCall> for Multicall2Calls {
        fn from(value: GetLastBlockHashCall) -> Self {
            Self::GetLastBlockHash(value)
        }
    }
    impl ::core::convert::From<TryAggregateCall> for Multicall2Calls {
        fn from(value: TryAggregateCall) -> Self {
            Self::TryAggregate(value)
        }
    }
    impl ::core::convert::From<TryBlockAndAggregateCall> for Multicall2Calls {
